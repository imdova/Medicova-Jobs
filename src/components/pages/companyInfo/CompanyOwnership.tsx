...
const CompanyOwnership: React.FC<OwnershipProps> = ({
  control,
  errors,
}) => {
  return (
    <div>
      ...
      <div className="mb-4 flex flex-wrap gap-5">
        <div className="flex-1">
          <label className="text-lg font-semibold text-main">Company Size</label>
          <Controller
            name="size"
            control={control}
            render={({ field }) => (
        ...
        <div className="flex-1">
          <label className="text-lg font-semibold text-main">Year Founded</label>
          <Controller
            name="yearFounded"
            control={control}
            render={({ field }) => (
