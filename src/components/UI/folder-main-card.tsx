...
import { getFullLastEdit, getLastEdit } from "@/util";
      ...
      <div className="relative">
        ...
        {(onDelete || onEdit) && (
          <IconButton
            ...
            className="absolute right-2 top-2 flex h-7 w-7 items-center justify-center rounded-full bg-white text-secondary"
          >
