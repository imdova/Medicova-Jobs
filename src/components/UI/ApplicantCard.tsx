...
import { formatName, getFullLastEdit } from "@/util";
import {
  Check,
  Download,
  Email,
            ...
            <div className="flex-1">
              <div className="mt-1 flex flex-wrap items-center gap-2 md:flex-nowrap">
                ...
                <div className="flex min-w-[80px] items-center rounded-base bg-primary-100 px-2 py-1 text-main">
                  <LocalPhone className="h-4 w-4 text-secondary md:h-5 md:w-5" />
                  {!isLocked ? (
                  ...
                  <CopyButton text={applicant.phone} disabled={isLocked} />
                </div>
                <div className="flex items-center rounded-base bg-primary-100 px-2 py-1 text-main">
                  <Email className="h-4 w-4 text-secondary md:h-5 md:w-5" />
                  {!isLocked ? (
                  ...
                  <CopyButton text={applicant.email} disabled={isLocked} />
                </div>
              </div>
