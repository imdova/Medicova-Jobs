...
const OverviewApplications: React.FC = () => {
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-8">
        <div className="col-span-1 lg:col-span-5">
          ...
          <div className="relative mt-3 overflow-hidden rounded-xl border bg-white shadow-soft">
            <GenericChart
              chartTitle="Statistics Applicatons Chart"
              data={{
                yearly: {
              ...
              cards={[
                { title: "New Applaction", value: "1,240", color: "#FF8743" },
                {
                  title: "Apply for a Applaction",
                  value: "2,480",
                  color: "#0884FF",
                },
              ]}
...
export default OverviewApplications;
