import { IconSkeleton } from "@/components/loading/loading";
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex items-center justify-between">
        <p className="flex flex-nowrap items-center text-secondary">
          <LocationOnOutlined className="mr-1 text-lg" />{" "}
          <span className="line-clamp-1 text-xs">{location}</span>
        </p>
        <p className="flex-nowrap text-nowrap text-xs text-secondary">
