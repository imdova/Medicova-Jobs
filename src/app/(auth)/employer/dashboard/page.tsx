        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-2 lg:grid-cols-3">
            <StatusCard
              ...
              value={total}
              icon={
                <WorkOutline className="block h-10 w-10 rounded-full bg-primary-100 p-2 text-primary" />
              }
              trend={{
            ...
            <StatusCard
              ...
              icon={
                <ShopOutlined className="block h-10 w-10 rounded-full bg-primary-100 p-2 text-primary" />
              }
              trend={{
            ...
            <StatusCard
              ...
              icon={
                <GroupOutlined className="block h-10 w-10 rounded-full bg-primary-100 p-2 text-primary" />
              }
              trend={{
